...
export function Login() {
  ...
  return (
    <div className="relative flex h-screen w-screen items-center justify-center bg-slate-950 text-slate-100 p-4 font-sans">
      ...
      <main className="w-full max-w-md bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-xl p-8 shadow-2xl shadow-purple-950/10 relative">
        ...
        <h1 className="text-xl font-semibold text-center mb-6">{t('auth:login.title')}</h1>
